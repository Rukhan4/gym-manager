...
<template>
    <div
        ...
        <div
            ...
            <!-- Header -->
            <header
                class="w-full bg-base-100/80 border-b border-base-300 shadow-sm backdrop-blur-sm">
                <div class="container mx-auto py-6 px-4">
                    <h1 class="text-4xl font-serif text-center text-primary">
                ...
                <div
                    ...
                    <section>
                        ...
                        <div class="overflow-x-auto flex justify-center">
                            <table
                                class="table-auto w-full max-w-4xl bg-base-100 rounded-xl shadow-lg">
                                <thead>
                        ...
                        <div
                            ...
                            <div
                                ...
                                <div
                                    ...
                                    <h3 class="text-xl font-bold text-sky-900">
                                        Edit Member Details
                                    </h3>
                                    <button
